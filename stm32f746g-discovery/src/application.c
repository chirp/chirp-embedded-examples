/**-----------------------------------------------------------------------------
 *
 *  Simple example of the Chirp C SDK on the STM32F746G-DISCOVERY.
 *
 *  @file application.c
 *
 *  @brief After creating a developer account on https://developers.chirp.io,
 *  get your key, secret and config string from your account using the
 *  "16kHz-mono-embedded" protocol, and set them in the credentials.h file.
 *
